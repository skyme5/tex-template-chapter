...
\begin{document}
	...
	\node[right of=label,height=0.5\paperheight,text width=.5\paperwidth] at ([yshift=-3.6cm, xshift=.5\paperwidth]current page text area.west|-current page.north){\raggedbottom \Huge This is a demonstration text for showing how line breaking works.};;

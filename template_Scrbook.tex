...
\begin{document}
	...
	\node[right of=label, height=7cm, minimum height=7cm,text width=.5\paperwidth] at ([yshift=-3.6cm, xshift=.5\paperwidth]current page text area.west|-current page.north){\raggedbottom \Huge This is a demonstration text for showing how line breaking works.};;

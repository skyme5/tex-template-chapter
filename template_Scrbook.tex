...
\begin{document}
	...
	\node[right of=label,fill=blue!25,text width=.5\paperwidth] at ([yshift=-3.5cm, xshift=.5\paperwidth]current page text area.west|-current page.north){\Huge This is a demonstration text for showing how line breaking works.};;

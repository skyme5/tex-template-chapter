...
\begin{document}
	...
	\node[right of=label,fill=blue!25,text width=3cm] at ([yshift=-6.5cm, xshift=5cm]current page text area.west|-current page.north){This is a demonstration text for showing how line breaking works.};;
